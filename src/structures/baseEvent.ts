...
export default class BaseEvent {
    ...
    once_autoModerationRuleCreate(
        autoModerationRule: AutoModerationRule,
    ): any | Promise<any> {}
    on_autoModerationRuleDelete(
        autoModerationRule: AutoModerationRule,
    ): any | Promise<any> {}
    once_autoModerationRuleDelete(
        autoModerationRule: AutoModerationRule,
    ): any | Promise<any> {}
    ...
    once_guildMemberUpdate(
        oldMember: GuildMember,
        newMember: GuildMember,
    ): any | Promise<any> {}
    on_guildSchduledEventCreate(
        guildScheduledEvent: GuildScheduledEvent,
    ): any | Promise<any> {}
    once_guildSchduledEventCreate(
        guildScheduledEvent: GuildScheduledEvent,
    ): any | Promise<any> {}
    on_guildSchduledEventDelete(
        guildScheduledEvent: GuildScheduledEvent,
    ): any | Promise<any> {}
    once_guildSchduledEventDelete(
        guildScheduledEvent: GuildScheduledEvent,
    ): any | Promise<any> {}
    ...
    once_messageDeleteBulk(
        messages: Collection<Snowflake, Message>,
    ): any | Promise<any> {}
    on_messagePollVoteAdd(
        pollAnswer: PollAnswer,
        userId: Snowflake,
    ): any | Promise<any> {}
    once_messagePollVoteAdd(
        pollAnswer: PollAnswer,
        userId: Snowflake,
    ): any | Promise<any> {}
    on_messagePollVoteRemove(
        pollAnswer: PollAnswer,
        userId: Snowflake,
    ): any | Promise<any> {}
    once_messagePollVoteRemove(
        pollAnswer: PollAnswer,
        userId: Snowflake,
    ): any | Promise<any> {}
    ...
    once_messageReactionRemoveEmoji(
        messageReaction: MessageReaction,
    ): any | Promise<any> {}
    on_messageUpdate(
        oldMessage: Message,
